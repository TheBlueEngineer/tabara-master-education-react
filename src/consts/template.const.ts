export const colorsLight = {
  ...
  /*   green50: 'hsl(144, 87%, 96%)',
  green100: 'hsl(147, 85%, 91%)',
  green200: 'hsl(147, 84%, 85%)',
  green300: 'hsl(148, 83%, 73%)',
  green400: 'hsl(152, 77%, 57%)',
  green500: 'hsl(151, 82%, 50%)',
  green600: 'hsl(151, 85%, 35%)',
  green700: 'hsl(151, 78%, 30%)',
  green800: 'hsl(151, 73%, 26%)',
  green900: 'hsl(150, 72%, 23%)',
  green950: 'hsl(151, 89%, 14%)', */
  /*   green50: 'hsl(134, 72%, 96%)',
  green100: 'hsl(135, 81%, 92%)',
  green200: 'hsl(135, 80%, 85%)',
  green300: 'hsl(135, 77%, 76%)',
  green400: 'hsl(135, 76%, 62%)',
  green500: 'hsl(135, 68%, 45%)',
  green600: 'hsl(135, 74%, 38%)',
  green700: 'hsl(135, 78%, 30%)',
  green800: 'hsl(135, 74%, 26%)',
  green900: 'hsl(135, 64%, 23%)',
  green950: 'hsl(135, 87%, 11%)', */
  // Secondary color
